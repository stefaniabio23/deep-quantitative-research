...
- [x] Add signal template. (Phase 3)
- [x] Add dataset contract template. (Phase 3)
- [x] Add experiment template. (Phase 3)
- [x] Add validation template. (Phase 3)
...
- [x] Add multiple-testing correction. (Phase 4 BH + Phase 8r Bonferroni + deflated correlation in `validation/selection_bias.py`, enforced via `check_selection_bias` which REFUSES to certify a result without a logged `features_tested` count.)
